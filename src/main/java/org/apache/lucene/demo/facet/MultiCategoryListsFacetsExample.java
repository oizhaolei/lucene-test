...
public class MultiCategoryListsFacetsExample {
    ...
    private void index() throws IOException {
        indexDir = new MMapDirectory(new File("MultiCategoryListsFacetsExample-i").toPath());
        taxoDir = new MMapDirectory(new File("MultiCategoryListsFacetsExample-t").toPath());
