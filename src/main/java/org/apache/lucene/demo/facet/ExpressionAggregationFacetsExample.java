...
public class ExpressionAggregationFacetsExample {
    ...
    private void index() throws IOException {
        indexDir = new MMapDirectory(new File("ExpressionAggregationFacetsExample-i").toPath());
        taxoDir = new MMapDirectory(new File("ExpressionAggregationFacetsExample-t").toPath());
